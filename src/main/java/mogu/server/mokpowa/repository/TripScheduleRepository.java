...
public interface TripScheduleRepository {
    ...
    UserInfo insertTripSchedule(TripScheduleInfo tripScheduleInfo, UserInfo user) throws Exception; // 여행 일정 생성
    
    TripSchedule getTripScheduleDetails(String groupKey) throws Exception; // 여행 일정 조회

    UserInfo updateTripSchedule(TripScheduleInfo tripSchedule, UserInfo user) throws Exception; // 여행 일정 정보 수정
